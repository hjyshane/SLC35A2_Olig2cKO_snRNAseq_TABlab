...
source('~/PTZ_ATAC_scRNA_072024/WIP/0624_run/CodeSource/16_find_dg.R')
...
qs::qsave(combined_object, file = file.path(qsave_dir, 'combined_cell_type_50.qs'))
...
go_dir <- file.path(save_dir, "GO")
cnet_dir <- file.path(save_dir, "GO", "cnet")
rrvgo_dir <- file.path(save_dir, "GO", "rrvgo")
