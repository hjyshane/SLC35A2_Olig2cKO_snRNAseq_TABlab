...
source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/01__load_rna_from_h5.R")
source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/02__create_seurat_object.R")
source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/03__rna_qc.R")
...
source('~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/08__ref_mousebrain_annotation.R')
```

## Folder directory
```{r Directories, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
# Directory setup
h5_input_dir <- 
...
# Save
qs::qsave(rna_list, 
          file = "~/SLC35A2_Olig2cKO_snRNA/WIP/QSAVE/01_rna_list.qs")

```

## Seurat Object creation
```{r [O] Create Seurat Object from RNA data, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
# source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/02__create_oligsub_man2ect.R")

# load previous object if needed
# rna_list <- qs::qread("~/SLC35A2_Olig2cKO_snRNA/WIP/QSAVE/01_rna_list.qs")

seurat_list <- 
  create_oligsub_man2ect(rna_list,
...
# R script located at "~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/02_Initial_VlnPlot.R"
...
# source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/03__rna_qc.R")

# load previous object if needed
# seurat_list <- qs::qread("~/SLC35A2_Olig2cKO_snRNA/WIP/QSAVE/02_rna_list_seurat.qs")
...
# Integration
```{r [O] Integrate RNA objects, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
...
# Fix 
integrated$TimePoint <- integrated$Timepoint
integrated$GenoType <- integrated$Genotype
integrated$Timepoint <- NULL
integrated$Genotype <- NULL

# Join layers after integration in RNA assay
Seurat::DefaultAssay(integrated) <- "RNA"
integrated <- Seurat::JoinLayers(integrated)
...
ref_obj <- Seurat::readRDS("~/SLC35A2_Olig2cKO_snRNA/WIP/mouseatlas_cut_processed.rds")
...
## "~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/99_CellCount_Slc35a2Check.R"
...
# Work only with Olig population
...
# Save
qs::qsave(oligsub_man, file = file.path(qsave_dir, "11_OligOnlyInit_manual.qs"))
qs::qsave(oligsub_ref, file = file.path(qsave_dir, "11_OligOnlyInit_refshort.qs"))
```   
```{r [O] Re-process, echo=TRUE, message=TRUE, warning=TRUE, paged.print=TRUE}
# Read previous object
# oligsub_man <- qs::qread(file.path(qsave_dir, "11_OligOnlyInit_refshort.qs"))
# oligsub_ref <- qs::qread(file.path(qsave_dir, "11_OligOnlyInit_manual.qs"))

# Normalize/process 
# source('~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/06_process_oligsub.R')
...
# Read previous object
# oligsub_man <- qs::qread(file.path(qsave_dir, "12_olig_processed_manual.qs"))
...
# Read previous object
# oligsub_ref <- qs::qread(file.path(qsave_dir, "12_olig_processed_refshort.qs"))
...
# Read previous object if needed.
# oligsub_man <- qs::qread(file.path(qsave_dir, "13_clustered_oligsub_manual.qs"))
...
# Read previous object if needed.
# oligsub_ref <- qs::qread(file.path(qsave_dir, "13_clustered_oligsub_refshort.qs"))
...
processed_list <- qs::qread(file.path(qsave_dir, "04_processed_rna_list.qs"))
integrated <- qs::qread(file.path(qsave_dir, "10_metadata_edited_obj.qs"))
source("~/SLC35A2_Olig2cKO_snRNA/WIP/SCRIPTS/SourceCode/04_doublet_process_rna.R")
