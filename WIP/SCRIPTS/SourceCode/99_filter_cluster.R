...
filter_cluster <- function(
  ...
  # Save
  if (save) {
    qs::qsave(filtered, file = file.path(qsave_dir, paste0("13_filtered_", number_to_filter, "_cells", suffix, ".qs")))
    message("Saved object to ", file.path(qsave_dir, paste0("13_filtered_", number_to_filter, "_cells", suffix, ".qs")), ".")
